...
This index serves as the primary entry point for the `dt-ai` intelligent research system. To minimize token usage, agents should consult this index first and only load the specific leaf node relevant to the current image's subject.

## Research Branches

| Subject | Summary | Leaf Node Path |
| :--- | :--- | :--- |
