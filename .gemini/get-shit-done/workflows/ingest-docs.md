...
```bash
INIT=$(node "/Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/get-shit-done/bin/gsd-tools.cjs" commit \
