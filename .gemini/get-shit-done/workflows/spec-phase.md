...
```bash
INIT=$(node "/Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/get-shit-done/templates/spec.md.
