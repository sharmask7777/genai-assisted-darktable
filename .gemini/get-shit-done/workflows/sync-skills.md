...
INSTALL_JS_GLOBAL="/Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
