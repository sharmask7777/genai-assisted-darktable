...
```
Task(
  prompt="Read /Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/get-shit-done/templates/SECURITY.md`
