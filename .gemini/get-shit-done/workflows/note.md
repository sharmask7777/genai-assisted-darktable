...
- **Global scope**: `/Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/notes/`)
...
2. Glob `/Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/notes/` — works in any directory
