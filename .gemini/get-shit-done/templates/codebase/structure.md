...
- Usage: Reference from command with `@/Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/shaleensharma/workplace/gemini_ws/photo-editting/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
